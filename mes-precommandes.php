...
<html lang="fr">
    <head>
        ...
        <title>Tes précommandes - Ton compte SHOE</title>
    ...
    <body class="compte">
        ...
        <div class="app-alert info">
            ...
            On fabrique environ 300 paires de chaussures en une semaine, tout à la
            main évidemment
        ...
        <main class="app-main">
            <div class="grid">
                ...
                <div class="app-subnavigation" role="navigation">
                    ...
                    <a href="mes-precommandes.php" class="active">
                ...
                <!-- Page Card -->
                <section class="card">
                    <h2>Tes précommandes</h2>
                    <p class="text-justify">
                        On fabrique toutes nos chaussures à la main. Des fois, ben y'en a
                        plus. Mais si y'en a plus, tu peux quand même commander tes SHOE !
                        Et tu les auras dans une semaine
                        <small>(à peu près, c'est pas une science exacte)</small>
                    </p>

                    <p class="text-success">Aucune précommande en cours…</p>
                </section>
            </div>
        </main>
